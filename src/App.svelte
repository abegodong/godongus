  ...
  const translations = {
    en: {
      ...
      diveMap: {
        ...
        triangulatedPois: 'Triangulated GPS',
        ...
        distance: 'Distance',
        kickCycles: 'Kick cycles',
        notes: 'Notes',
        poisLoading: 'Loading Dead Reckoning POIs...',
        poisUnavailable: 'Unable to load Dead Reckoning POIs',
        triangulatedPoisUnavailable: 'Unable to load triangulated GPS points',
        depthLoading: 'Checking depth...',
        depthUnavailable: 'No depth data at this point',
      },
      error: {
        label: 'Error',
    ...
    id: {
      ...
      diveMap: {
        ...
        triangulatedPois: 'GPS triangulasi',
        observationPoints: 'Titik observasi',
        ...
        fromPoint: 'Dari titik',
        distance: 'Jarak',
        kickCycles: 'Kick cycles',
        notes: 'Catatan',
        poisLoading: 'Memuat POI dead reckoning...',
        poisUnavailable: 'Tidak dapat memuat POI dead reckoning',
        triangulatedPoisUnavailable: 'Tidak dapat memuat titik GPS triangulasi',
        depthLoading: 'Memeriksa kedalaman...',
        depthUnavailable: 'Tidak ada data kedalaman di titik ini',
      },
      error: {
        label: 'Error',
    ...
    es: {
      ...
      diveMap: {
        ...
        deadReckoningPois: 'POI',
        triangulatedPois: 'GPS triangulado',
        ...
        fromPoint: 'Desde el punto',
        distance: 'Distancia',
        kickCycles: 'Ciclos de aleteo',
        notes: 'Notas',
        poisLoading: 'Cargando POI de navegación estimada...',
        poisUnavailable: 'No se pudieron cargar los POI de navegación estimada',
        triangulatedPoisUnavailable: 'No se pudieron cargar los puntos GPS triangulados',
        depthLoading: 'Consultando profundidad...',
        depthUnavailable: 'No hay datos de profundidad en este punto',
      },
      error: {
        label: 'Error',
